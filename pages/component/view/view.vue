		...
		<view class="uni-padding-wrap uni-common-mt">
			...
			<view>
				...
				<view class="uni-flex uni-row" style="flex-wrap: wrap;">
					<view class="text" style="width: 280upx;">一行不全，wrap折行</view>
					<view class="text" style="width: 280upx;">一行不全，wrap折行</view>
					<view class="text" style="width: 280upx;">一行不全，wrap折行</view>
				</view>
				<view class="uni-flex uni-row">
					<view class="text" style="flex: 1;height: 200upx;display: flex;justify-content: center;align-items: flex-start;">垂直居顶</view>
					<view class="text" style="flex: 1;height: 200upx;display: flex;justify-content: center;align-items: center;">垂直居中</view>
					<view class="text" style="flex: 1;height: 200upx;display: flex;justify-content: center;align-items: flex-end;">垂直居底</view>
				</view>
			</view>
			<view class="uni-title uni-common-mt">
				组合示例
...
<style>
.flex-item{width: 33.3%; height: 200upx;text-align: center;line-height: 200upx;}
.flex-item-V{width: 100%;height: 150upx; line-height: 150upx;}
.text{margin: 15upx 10upx;padding: 0 20upx;background-color: #ebebeb;height: 70upx;line-height:70upx;text-align: center;color: #777;font-size: 26upx;}
</style>
